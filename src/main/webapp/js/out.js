...
function formatActionData(value,row,index){
    return '<span class="messageT">'+row.dataD+'</span>';
}
...
function read(event){
    ...
    var odid= e.target.parentNode.parentNode.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.previousSibling.innerText;
    $.ajax({
        type: "POST",
