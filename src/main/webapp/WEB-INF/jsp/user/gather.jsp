...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/css/gather_user.css"/>
...
<div id="table">
    <table id="datagrid" class="easyui-datagrid" fit="true" url="${path}/gather/datagrid" title="信息汇总"
           toolbar="#toolbar"
           pagination="true"
           fitColumns="true"
           singleSelect="true"
        ...
        <tr>
            ...
            formatter: function(value,row,index){
                var binary=parseInt(row.oldMan.gatewayID).toString(2)+'';
                switch (binary.length) {
                    case 1:
                        return row.oldMan.gatewayID + '(000' + binary + ')';
                        break;
                    case 2:
                        return row.oldMan.gatewayID + '(00' + binary + ')';
                        break;
                    case 3:
                        return row.oldMan.gatewayID + '(0' + binary + ')';
                         break;
                    default:
                        return row.oldMan.gatewayID + '(' + binary + ')';
            }
     }" >网关</th>
