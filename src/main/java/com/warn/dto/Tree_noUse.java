...
public class Tree_noUse {
	...
	private Object attributes;			//给一个节点追加的自定义属性 url
	private List<Tree_noUse> children;		//定义了一些子节点的节点数组
	...
	public List<Tree_noUse> getChildren() {
		return children;
	}
	public void setChildren(List<Tree_noUse> children) {
